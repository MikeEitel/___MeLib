//  AGS10.cpp
// Modified by Mike Eitel as caused errors in compilation
...
void Me_AGS10::begin() {
    //Wire.begin();             // Me   To make multi SPI possible
  }

void Me_AGS10::calibrateFact() {
    uint8_t data[4] = {CALIB_CMD1, CALIB_CMD2, CALIB_FACT, CALIB_FACT};
    _crc = Calc_CRC8(data, sizeof(data));
...
void Me_AGS10::calibrateCust(uint8_t CALIB_RES1, uint8_t CALIB_RES2) {
...
void Me_AGS10::setAddress(uint8_t newAddr) {
...
uint8_t Me_AGS10::Calc_CRC8(uint8_t *dat, uint8_t Num) {
