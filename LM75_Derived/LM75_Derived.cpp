...
LM75_Derived::RegisterLayout LM75_Compatible_Registers = {
  .temperature      = 0x00,
  .configuration    = 0x01,
...
LM75_Derived::Attributes Generic_LM75_Attributes = {
...
LM75_Derived::Attributes Generic_LM75_10Bit_Attributes = {
  .temperature_width              = 16,
...
LM75_Derived::Attributes Generic_LM75_11Bit_Attributes = {
  .temperature_width              = 16,
...
LM75_Derived::Attributes Generic_LM75_12Bit_Attributes = {
  .temperature_width              = 16,
...
LM75_Derived::Attributes TI_TMP102_Attributes = {
  .temperature_width              = 16,
  .default_temperature_resolution = 12,
  .default_temperature_frac_width = 8,
...
int16_t LM75_Derived::readIntegerTemperatureRegister(uint8_t register_index) {
...
void LM75_Derived::writeIntegerTemperatureRegister(uint8_t register_index, int16_t value) {
  bus->beginTransmission(i2c_address);
