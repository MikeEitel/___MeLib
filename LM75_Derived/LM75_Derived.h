#ifndef LM75_DERIVED_H
#define LM75_DERIVED_H
...
public:
  ...
  LM75_Derived(TwoWire *bus, uint8_t i2c_address, Attributes *attributes) {
    this->bus = bus;
...
extern LM75_Derived::Attributes Generic_LM75_Attributes;

class Generic_LM75_Compatible : public LM75_Derived {
protected:
...
public:
  ...
  Generic_LM75_Compatible(TwoWire *bus, uint8_t i2c_address, Attributes *attributes)
    : LM75_Derived(bus, i2c_address, attributes) { };
...
extern LM75_Derived::Attributes Generic_LM75_10Bit_Attributes;
...
extern LM75_Derived::Attributes Generic_LM75_11Bit_Attributes;
...
extern LM75_Derived::Attributes Generic_LM75_12Bit_Attributes;
...
extern LM75_Derived::Attributes TI_TMP102_Attributes;
